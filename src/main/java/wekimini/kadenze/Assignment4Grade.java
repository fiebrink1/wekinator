 ...
 * @author rebecca
 */
public class Assignment4Grade {

    public Assignment4Grade() {
    }
    ...
    private static final Logger logger = Logger.getLogger(Assignment4Grade.class.getName());
    ...
    public static enum Assignment4Part {

        PART1A, PART1B, PART1C, PART2
    };

    //TODO
    void scorePartFail(Assignment4Part assignmentPart, Outcome outcome) {
    ...
    public void score1bAdaBoostAccuracy(Outcome o, double score) {
        ...
        part1bAdaboostAccuracy.setNoteWithErrValue(o, "assignment4_1A");
        if (o == Outcome.SUCCESS) {
    ...
    public void score1bDTreeAccuracy(Outcome o, double score) {
        ...
        part1bDTreeAccuracy.setNoteWithErrValue(o, "assignment4_1A");
        if (o == Outcome.SUCCESS) {
    ...
    public void score1bSVMAccuracy(Outcome o, double score) {
        ...
        part1bSVMAccuracy.setNoteWithErrValue(o, "assignment4_1A");
        if (o == Outcome.SUCCESS) {
    ...
    public void score1cAdaBoostAccuracy(Outcome o, double score) {
        ...
        part1cAdaboostAccuracy.setNoteWithErrValue(o, "assignment4_1A");
        if (o == Outcome.SUCCESS) {
    ...
    public void score1cDTreeAccuracy(Outcome o, double score) {
        ...
        part1cDTreeAccuracy.setNoteWithErrValue(o, "assignment4_1A");
        if (o == Outcome.SUCCESS) {
    ...
    public void score1cSVMAccuracy(Outcome o, double score) {
        ...
        part1cSVMAccuracy.setNoteWithErrValue(o, "assignment4_1A");
        if (o == Outcome.SUCCESS) {
    ...
    public void score2Experimented(Outcome o, double score) {
        ...
        part2Experimented.setNoteWithErrValue(o, "assignment4_2");
    }
