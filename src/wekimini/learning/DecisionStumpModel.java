 ...
 * @author rebecca
 */
public class DecisionStumpModel implements SupervisedLearningModel {
    
    private final String prettyName;
    private final String timestamp;
    private final String myId;
    private transient DecisionStump wmodel;
    private static final Logger logger = Logger.getLogger(DecisionStumpModel.class.getName());
    
    public DecisionStumpModel(String name, DecisionStump wmodel) { 
