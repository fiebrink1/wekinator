 ...
 * @author rebecca
 */
public class LabeledSelectionGrid_2 extends javax.swing.JFrame {
     ...
     */
    public LabeledSelectionGrid_2(int numRows, int numCols, String[] rowNames, String[] colNames) {
        ...
        //TODO: add vertical labels
        jPanel1.removeAll();
        jPanel1.setLayout(new java.awt.GridLayout(numRows+1, numCols+1));
        toggles = new MyToggle[numRows][numCols];
        JLabel blank = new JLabel("");
        jPanel1.add(blank);
        for (int i = 0; i < numCols; i++) {
            this.colNames[i] = new JLabel(colNames[i]);
            jPanel1.add(this.colNames[i]);
        }
        
        for (int i = 0; i < numRows; i++) { 
            this.rowNames[i] =new JLabel(rowNames[i]);
            jPanel1.add(this.rowNames[i]);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String[] rowNames = {"r1", "r2", "r3", "r4", "r5"};
                String[] colNames = {".", ".", ".", "."};
                
                new LabeledSelectionGrid_2(5, 4, rowNames, colNames).setVisible(true);
            }
        });
    }
