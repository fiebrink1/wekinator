 ...
 * @author fiebrink
 */
public class SimpleLearningSet1_TEMP extends javax.swing.JPanel {
    private Wekinator w;
     ...
     */
    public SimpleLearningSet1_TEMP() {
        initComponents();
    ...
    public SimpleLearningSet1_TEMP(Wekinator w, Path[] ps, String[] modelNames) {
        initComponents();
