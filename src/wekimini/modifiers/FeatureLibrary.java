...
public final class FeatureLibrary 
{
    ...
    public FeatureLibrary(FeatureGroup fg)
    {
        ...
        library.add(new FFTFeature("FFTAccX7Bins", 0, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new FFTFeature("FFTAccY7Bins", 1, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new FFTFeature("FFTAccZ7Bins", 2, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new FFTFeature("FFTGyroX7Bins", 3, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new FFTFeature("FFTGyroY7Bins", 4, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new FFTFeature("FFTGyroZ7Bins", 5, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MaxFFT("MaxFFTAccX", 0, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MaxFFT("MaxFFTAccY", 1, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MaxFFT("MaxFFTAccZ", 2, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MaxFFT("MaxFFTGyroX", 3, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MaxFFT("MaxFFTGyroY", 4, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MaxFFT("MaxFFTGyroZ", 5, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MinFFT("MinFFTAccX", 0, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MinFFT("MinFFTAccY", 1, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MinFFT("MinFFTAccZ", 2, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MinFFT("MinFFTGyroX", 3, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MinFFT("MinFFTGyroY", 4, 64, new int[]{0,8,16,24,36,48,60}));
        library.add(new MinFFT("MinFFTGyroZ", 5, 64, new int[]{0,8,16,24,36,48,60}));
