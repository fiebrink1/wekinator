...
public class Assignment7Grade {
    ...
    public void scoreExperimented(Outcome o, double score) {
        ...
        experimented.setNoteWithErrValue(o, "assignment7");
    }
    ...
    public void scoreQuestions(double[] qs) {
        ...
        my_q1.setNoteWithErrValue(o, "assignment7");

        my_q2.setScore(qs[1]);
        o = setQuestionOutcomeFromScore(qs[1]);
        my_q2.setNoteWithErrValue(o, "assignment7");

        my_q3.setScore(qs[2]);
        o = setQuestionOutcomeFromScore(qs[2]);
        my_q3.setNoteWithErrValue(o, "assignment7");

        my_q4.setScore(qs[3]);
        o = setQuestionOutcomeFromScore(qs[3]);
        my_q4.setNoteWithErrValue(o, "assignment7");

        my_q5.setScore(qs[4]);
        o = setQuestionOutcomeFromScore(qs[4]);
        my_q5.setNoteWithErrValue(o, "assignment7");

       /* my_q6.setScore(qs[5]);
        o = setQuestionOutcomeFromScore(qs[5]);
        my_q6.setNoteWithErrValue(o, "assignment7");
        
        my_q7.setScore(qs[6]);
        o = setQuestionOutcomeFromScore(qs[6]);
        my_q7.setNoteWithErrValue(o, "assignment7"); */
        
        my_q8.setScore(qs[7]);
        o = setQuestionOutcomeFromScore(qs[7]);
        my_q8.setNoteWithErrValue(o, "assignment7");
    }
